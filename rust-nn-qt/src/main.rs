...
mod frontend_new;
use frontend_new::NeuralNetworkApp;
...
fn train_neural_network(
    ...
    println!("Using dataset: {}", dataset_path);
    
    let (x, y_true) = load_data(&dataset_path)?;
