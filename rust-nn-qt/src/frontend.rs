            ...
            ui.vertical(|ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        ui.colored_label(egui::Color32::GOLD, "Epochs:");
                    ...
                    ui.vertical(|ui| {
                        ui.set_width(item_width);
                        ui.colored_label(egui::Color32::GOLD, "Hidden Layer Size:");
                        let mut config = network_config.lock().unwrap();
                        ui.add_sized(
                            [item_width, 30.0],
                    ...
                    ui.vertical(|ui| {
                        ui.set_width(item_width);
                        ui.colored_label(egui::Color32::GOLD, "Learning Rate:");
                        let mut config = network_config.lock().unwrap();
                        ui.add_sized(
                            [item_width, 30.0],
            ...
            ui.vertical_centered(|ui| {
                ...
                ui.with_layout(egui::Layout::top_down(egui::Align::Center), |ui| {
                    ...
                    if ui.add_sized(
                        ...
                        .fill(if can_train { egui::Color32::from_rgb(0, 120, 215) } else { egui::Color32::DARK_GRAY })
                    ).clicked() && can_train {
                        train_click = true;
                    }
                    ...
                    if ui.add_sized(
                        ...
                        .fill(if data.training_in_progress { egui::Color32::from_rgb(255, 140, 0) } else { egui::Color32::DARK_GRAY })
